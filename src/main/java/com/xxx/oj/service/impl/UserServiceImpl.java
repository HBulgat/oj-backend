...
import com.xxx.oj.mapper.UserMapper;
import com.xxx.oj.model.dto.user.UserQueryRequest;
import com.xxx.oj.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public boolean userLogout(HttpServletRequest request) {
        ...
        log.error(request.getSession().getAttribute(UserConstant.USER_LOGIN_STATE)==null?"1":"0");
        return true;
    }
